  ...
  return (
    ...
    >
      ...
      <div className={`flex-1 flex items-center justify-center mt-12 md:mt-0 z-10 transition-opacity duration-1000 delay-200 ${show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="w-64 h-64 md:w-80 md:h-80 bg-dark-800/80 border-4 border-retrored rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden">
          <img
            src={logo}
            alt="NexaWorks Logo"
            className={`max-w-[80%] max-h-[80%] object-contain transition-transform duration-1000 ease-out ${show ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}
